...
function getUserList(room) {
    ...
    if(clients) {
        ...
        clients.forEach((client) => {
            ...
            // 사용자 정보 객체 생성
            // .userName 은 닉네임을 가져오는 메소드
            // 58. const userSocket = io.sockets.sockets.get(client).userName 이랑 같은 것 임
