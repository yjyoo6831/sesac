...
export default class ClassBind extends Component{
    constructor(props){
        ...
        console.log("constructor this :",this); //생성자 내에서 'this'가 무엇을 가르키는지 출력한다.
        this.state={name:"sesac",}
        // #1. 클래스 컴포넌트에서 이벤트 사용 - bind 쓰기
        /*
            - 'bind' 메서드로 'this' 바인딩
            - Q) 바인딩(binding) 이란 ?
             - 프로그램의 어떤 기본 단위가 가질 수 있는 구성요소의 구체적인 값, 성격을 확정 짓는 것 

             - js 에서 'this' 는 함수가 호출되는 방식에 따라 달라질 수 있다. 
             - 즉, 'this'가 무엇을 가르키는지 명확하게 해주기 위해 바인딩이 필요하다. 
    ...
    printConsole2(evt,msg,msg2) {
        ...
        console.log("evt >>> ",evt);
        console.log("msg >> ",msg);
        console.log("msg2(추가로 전달된 인자) >> ",msg2);
