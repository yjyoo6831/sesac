                    ...
                    {sells.length > 0 ? (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            {sells.map((sell, index) => (
                                ...
                                >
                                    {/* <span>{sell.productId}</span> */}
                                    <Avatar
                                        img={
                                            sell.ProductImages.length === 0 || !sell.ProductImages[0].productImage
                                                ? '/images/product.png'
                                    ...
                                    <div className="ml-6 flex-1">
                                        <h2 className="text-lg font-semibold">{sell.productName}</h2>
                                        <p className="text-xl font-bold text-gray-800 mt-2">{sell.price}원</p>
                                        <p className="text-gray-500 mt-1">{sell.status}</p>
                                    </div>
                                    {(sell.status === '판매중' && sell.buyerId) &&
                                        (
