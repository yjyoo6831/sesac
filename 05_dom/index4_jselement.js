...
//x.appendChild(y) : x요소의 맨 마지막 자식으로 y요소가 추가됨.
div1.appendChild(p);
...
//요소 삭제 
// x.remove() : x요소 자체를 삭제 
// x.removeChild() : x의 자식요소인 y가 삭제 

const firstLi = document.querySelector('li');
console.log(firstLi);// 친구 소개합니다 태그 

const ul= firstLi.parentNode;
// ul.removeChild(firstLi); // ul 의 자식요소 firstLi 가 삭제됨 
firstLi.remove(); //선택된 요소 자체가 사라진다. 
